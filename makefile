syko.exe:
	...
	gcc mem_abs.o f_add1.o f_add2.o f_jmp_memc.o f_jmp_rel.o f_mov1.o f_fmul.o f_fmuls.o f_fmulsu.o  f_ldi.o   f_out.o   f_elpm_arg1.o                                           interrupt.o interpreter.o main.o -o syko.exe
